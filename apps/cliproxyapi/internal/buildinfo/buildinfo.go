...
var (
	...
	// Flavor identifies the distribution flavor of the binary.
	// Example values: default, desktop-lite.
	Flavor = "default"
)

// IsDesktopLite reports whether the current binary is the trimmed desktop build.
func IsDesktopLite() bool {
	return Flavor == "desktop-lite"
}
