...
// SetHook replaces the lifecycle hook used for auth register/update notifications.
// It is intended for service bootstrap before concurrent auth operations begin.
